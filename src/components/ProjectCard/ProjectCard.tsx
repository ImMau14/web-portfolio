...
export const ProjectCard = ({
  ...
  return (
    <article
      className={`grid h-[400px] w-full transform grid-rows-[auto_1fr] overflow-hidden rounded-xl border-2 border-silver-700 bg-gradient-to-b from-silver-850 via-silver-900 to-silver-950 shadow-light ease-in-out md:transition-transform md:duration-200 md:hover:scale-[104%] ${className}`}
