...
const RepoCard = ({ data, langData }: RepoCardProps) => {
  ...
  return (
    <article className="flex h-[600px] transform flex-col items-center gap-4 overflow-hidden rounded-xl border-2 border-silver-700 bg-gradient-to-b from-silver-850 via-silver-900 to-silver-950 p-2 shadow-light transition-transform duration-1000 ease-in-out hover:scale-[102%] md:w-full">
