...
const RepoCard = ({ data, langData }: RepoCardProps) => {
  ...
  const repoName = githubUrl.replace("https://www.github.com/", "").replace("https://github.com/", "")
  ...
  return (
    <article className="flex h-[600px] flex-col items-center gap-4 rounded-xl border-2 border-silver-700 bg-gradient-to-b from-silver-850 via-silver-900 to-silver-950 p-2 md:w-full">
      ...
      <div className="flex h-full w-full flex-col gap-4 px-2 pb-2">
        <h1 className="font-heading text-2xl text-silver-400">{repoName}</h1>
        ...
        <div className="mt-auto flex w-full flex-row justify-between gap-4">
          <span className="font-body text-sm text-silver-450/80">
