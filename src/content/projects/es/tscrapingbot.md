...
TScrapingBot es un bot de Telegram avanzado que automatiza el web scraping y el análisis de información, potenciado por el LLM Gemini 2.5.

Ofrece respuestas inteligentes, análisis de contenido web, modo de razonamiento y memoria convencional.

Desarrollado en Python, integra Gemini 2.5, Scrape.do y Supabase, para una extracción de datos y consultas inteligentes directamente desde Telegram.
